				...
				.then(result => {
					...
					result.forEach(toot => {
						...
						if(toot.content != undefined){
							...
							toot.content = this.Helper.stripTagFromContent(toot.content,toot.tags);
						}
						...
						if(toot.reblog != undefined){
							...
							toot.reblog.content = this.Helper.stripTagFromContent(toot.reblog.content,toot.reblog.tags);
						}
