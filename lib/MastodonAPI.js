...
export default class MastodonAPI {
	...
	changeDisplayName(args){
		return new Promise((resolve,reject) => {
			const url = encodeURI(args.base_url + 'api/v1/accounts/update_credentials');
			const body = 'display_name=' + args.display_name;
			const options = this.Helper.makeFetchOption('PATCH',args.access_token,'application/x-www-form-urlencoded',body);
